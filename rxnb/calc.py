...
def perform_xtbts_calc(symbols,init_coords,charge,multiplicity,fixed_inf_lst,opt_from_step=1,loose=False,
    ...
    if opt_from_step == 1:
        # Step 1
        if loose:
            mod_opt_kwd_line = "#p opt=(modredundant,nomicro,loose) external='./xtb.sh'"
        else:
            mod_opt_kwd_line = "#p opt=(modredundant,nomicro) external='./xtb.sh'"
        ...
        # Step 3
        if not loose:
            ts_opt_kwd_line = "#p opt(ts,calcfc,noeigen,nomicro) external='./xtb.sh'"
        else:
            ts_opt_kwd_line = "#p opt(ts,calcfc,noeigen,nomicro,loose) external='./xtb.sh'"
        print("[INFO] (3/4) Start performing TS optimization...")
        write_gjf(symbols,mod_opted_coords,ts_opt_gjf_file,
                    kwd_line=ts_opt_kwd_line,
        ...
        return True,None,4
    elif opt_from_step == 3:
        # Step 3
        print("[INFO] (3/4) Start performing TS optimization...")
        write_gjf(symbols,init_coords,ts_opt_gjf_file,
